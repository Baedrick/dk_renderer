...
namespace dk {
	...
	enum DKS_SectionKind : u32 {
		...
		DKS_SECTION_KIND_NODES,
		DKS_SECTION_KIND_GPU_TRANSFORMS,
	...
	using DKS_SectionElementType_Nodes                = DKS_Node;
	using DKS_SectionElementType_GPU_Transforms       = DKS_GPU_Transform;
	...
	template <> struct DKS_SectionTraits<DKS_SECTION_KIND_NODES>                 { using Type = DKS_SectionElementType_Nodes; };
	template <> struct DKS_SectionTraits<DKS_SECTION_KIND_GPU_TRANSFORMS>        { using Type = DKS_SectionElementType_GPU_Transforms; };
